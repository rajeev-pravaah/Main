...
public class TC_050TotalChcekBox extends BaseClass80 {
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_050TotalcheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getTotalcheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Total check box is unchecked successfully");
		System.out.println("INFO: Total check box is unchecked successfully");
		bs.getTotalcheckbox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Total  check box is checked successfully");
		System.out.println("INFO:Total check box is checked successfully");
