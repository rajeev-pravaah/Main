...
public class TC_176SubmitBankDetailsButton extends BaseClass80 {
	ExcelUtility elib;
	javautility jlib;
	LoginPage lp;
	HomePage hp;
	...
	@Test
	public void TC_176SubmitBankDetailsButton()
		...
		try {
			...
			utilityclassobject.gettest().log(Status.INFO,
					"Default value of Account Sub Type dropdown: '" + defaultValue + "'");
			...
			if (selectedValue.equalsIgnoreCase("Checking")) {
				utilityclassobject.gettest().log(Status.PASS,
						"Selected 'Checking' from Account Sub Type dropdown successfully");
				System.out.println("PASS: Selected 'Checking' from Account Sub Type dropdown successfully");
			} else {
				utilityclassobject.gettest().log(Status.FAIL,
			...
			utilityclassobject.gettest().log(Status.FAIL,
					"FAIL: Could NOT select from accountSubType dropdown - " + e.getMessage());
			System.out.println("FAIL: Could NOT select from accountSubType dropdown - " + e.getMessage());
		}

		// ======================================================
		// Step 15: Click "Submit Bank Details" button
		// Uses submitBankDetailsButtoninACH from BillingSettings.java
		// xpath: //button[contains(text(),'Submit Bank Details')]
		// ======================================================
		try {
			...
			System.out.println("INFO: 'Submit Bank Details' button found, attempting click...");
			...
			Thread.sleep(2000);
			utilityclassobject.gettest().log(Status.PASS,
					"Clicked 'Submit Bank Details' button successfully");
			System.out.println("PASS: Clicked 'Submit Bank Details' button successfully");
		...
		driver.switchTo().defaultContent();
		Thread.sleep(1000);
		utilityclassobject.gettest().log(Status.INFO, "Payment method added successfully, switched back to default content");
		System.out.println("INFO: Payment method added successfully, switched back to default content");
