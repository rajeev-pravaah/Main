...
public class TC_093SubsequentWithdaysTextfield extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_093SubsequentCheckBoxWithDaysTextfield() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		actions.click(daystxtfield).keyDown(org.openqa.selenium.Keys.CONTROL).sendKeys("a").keyUp(org.openqa.selenium.Keys.CONTROL).perform();
		daystxtfield.sendKeys(org.openqa.selenium.Keys.DELETE);
		daystxtfield.sendKeys("5");
		utilityclassobject.gettest().log(Status.INFO, "Days text field is enabled and value is entered successfully");
		System.out.println("INFO: Days text field is enabled and value is entered successfully");
	}
}