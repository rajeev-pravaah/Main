...
public class TC_109AutmaticSuspensiondropdownwith5thvlause extends BaseClass80 {
	...
	@Test
	public void TC_109AutmaticSuspensiondropdownwith5thvlause() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		// Fetch 5th value
		if (allOptions != null && allOptions.size() >= 5) {
			String fifthValue = allOptions.get(4).getText().trim();
			System.out.println("5th Value from dropdown: " + fifthValue);
			utilityclassobject.gettest().log(Status.INFO, "5th Value from dropdown: " + fifthValue);
		} else {
			System.out.println("5th option not found in the dropdown");
			utilityclassobject.gettest().log(Status.FAIL, "5th option not found in the dropdown");
		}
	}
}
