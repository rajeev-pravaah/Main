...
public class TC_114AutmaticSuspensiondropdownwith10thvlause extends BaseClass80 {
	...
	@Test
	public void TC_114AutmaticSuspensiondropdownwith10thvlause() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		// Fetch 10th value
		if (allOptions != null && allOptions.size() >= 10) {
			String tenthValue = allOptions.get(9).getText().trim();
			System.out.println("10th Value from dropdown: " + tenthValue);
			utilityclassobject.gettest().log(Status.INFO, "10th Value from dropdown: " + tenthValue);
		} else {
			System.out.println("10th option not found in the dropdown");
			utilityclassobject.gettest().log(Status.FAIL, "10th option not found in the dropdown");
		}
	}
}
