...
public class TC_041OverduetotalNotice extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_041OverdueTotalNotice() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getOverdueTotalNoticeCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Overdue total notice check box is unchecked successfully");
		System.out.println("INFO: Overdue total notice check box is unchecked successfully");
		bs.getOverdueTotalNoticeCheckbox().click();
			
		utilityclassobject.gettest().log(Status.INFO, "Overdue total notice check box is checked successfully");
		System.out.println("INFO: Overdue total notice check box is checked successfully");
