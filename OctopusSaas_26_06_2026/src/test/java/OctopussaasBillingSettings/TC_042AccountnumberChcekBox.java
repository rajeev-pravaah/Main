...
public class TC_042AccountnumberChcekBox extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_042AccountNumbercheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getAccountNumberCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Account Number check box is unchecked successfully");
		System.out.println("INFO: Account Number check box is unchecked successfully");
		bs.getAccountNumberCheckbox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Account Number check box is checked successfully");
		System.out.println("INFO: Account Number check box is checked successfully");
