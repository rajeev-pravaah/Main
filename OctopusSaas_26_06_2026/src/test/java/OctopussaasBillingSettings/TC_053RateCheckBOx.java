...
public class TC_053RateCheckBOx extends BaseClass80 {
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_053RatecheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getRateCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Rate check box is unchecked successfully");
		System.out.println("INFO: Rate check box is unchecked successfully");
		bs.getRateCheckbox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Rate check box is checked successfully");
		System.out.println("INFO:Rate check box is checked successfully");
