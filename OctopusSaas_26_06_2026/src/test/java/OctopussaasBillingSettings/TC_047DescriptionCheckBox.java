...
public class TC_047DescriptionCheckBox extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_047DescriptioncheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getDescriptionChcekbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Description  check box is unchecked successfully");
		System.out.println("INFO: Description box is unchecked successfully");
		bs.getDescriptionChcekbox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Description  check box is checked successfully");
		System.out.println("INFO:Description check box is checked successfully");
