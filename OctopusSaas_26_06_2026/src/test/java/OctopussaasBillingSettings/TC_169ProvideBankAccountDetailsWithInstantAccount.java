...
public class TC_169ProvideBankAccountDetailsWithInstantAccount extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	LoginPage lp;
	HomePage hp;
	...
	@Test
	public void TC_169ProvideBankAccountDetailsWithInstantAccount() throws InterruptedException, EncryptedDocumentException, IOException {
