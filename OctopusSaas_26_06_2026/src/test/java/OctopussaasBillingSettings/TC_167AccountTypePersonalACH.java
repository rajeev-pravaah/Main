...
public class TC_167AccountTypePersonalACH extends BaseClass80 {
	...
	@Test
	public void TC_167AccountTypePersonalACH() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		// Step 11: Switch to iframe → click on Account Type dropdown → select 'Personal' → verify selection
		JavascriptExecutor js = (JavascriptExecutor) driver;
		boolean selectionVerified = false;
		final String EXPECTED_VALUE = "Personal";
