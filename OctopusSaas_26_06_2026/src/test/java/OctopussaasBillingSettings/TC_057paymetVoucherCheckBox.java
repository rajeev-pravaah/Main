...
public class TC_057paymetVoucherCheckBox extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_057PaymentVoucherCheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getPaymentVoucherCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Payment voucher check box is unchecked successfully");
		System.out.println("INFO: Payment voucher check box is unchecked successfully");
		bs.getPaymentVoucherCheckbox().click();
		Thread.sleep(2000); 	
		utilityclassobject.gettest().log(Status.INFO, "Payment vouchercheck box is checked successfully");
		System.out.println("INFO:Payment voucher check box is checked successfully");
