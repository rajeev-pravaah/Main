...
public class TC_083DeliverAttachedImage extends Baseclass{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_083DeliverAttachImage() throws InterruptedException, EncryptedDocumentException, IOException, AWTException, HeadlessException, UnsupportedFlavorException {
