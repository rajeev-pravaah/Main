...
public class TC_046DocumentIdchcekBox extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_046DocumentIdcheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getDocumentIDCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Document ID check box is unchecked successfully");
		System.out.println("INFO: Document ID check box is unchecked successfully");
		bs.getDocumentIDCheckbox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Document ID  check box is checked successfully");
		System.out.println("INFO:Document ID check box is checked successfully");
