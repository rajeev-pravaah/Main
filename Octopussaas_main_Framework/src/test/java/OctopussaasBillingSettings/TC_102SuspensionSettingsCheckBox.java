...
public class TC_102SuspensionSettingsCheckBox extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_102SuspensionSettingscheckBox() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		Thread.sleep(2000);
		wlib.scrollToelement(driver, bs.getSuspensiionsettingcheckbox());
		Thread.sleep(2000);
		bs.getSuspensiionsettingcheckbox().click();
		bs.getSuspensiionsettingcheckbox().click();
utilityclassobject.gettest().log(Status.INFO, "Suspension setting checkbox is clicked successfully");
		System.out.println("INFO: Suspension setting checkbox is clicked successfully");
	}
