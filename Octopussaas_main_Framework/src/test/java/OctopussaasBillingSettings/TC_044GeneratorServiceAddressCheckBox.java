...
public class TC_044GeneratorServiceAddressCheckBox extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_044GeneratorServiceAddresscheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getGeneratorServiceAddressCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Generator service address check box is unchecked successfully");
		System.out.println("INFO: Generator service address  check box is unchecked successfully");
		bs.getGeneratorServiceAddressCheckbox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Generator service address  check box is checked successfully");
		System.out.println("INFO: Generator service address  check box is checked successfully");
