...
public class TC_115AutmaticSuspensiondropdownwith11thvlause extends BaseClass80 {
	...
	@Test
	public void TC_115AutmaticSuspensiondropdownwith11thvlause() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		// Fetch 11th value
		if (allOptions != null && allOptions.size() >= 11) {
			String eleventhValue = allOptions.get(10).getText().trim();
			System.out.println("11th Value from dropdown: " + eleventhValue);
			utilityclassobject.gettest().log(Status.INFO, "11th Value from dropdown: " + eleventhValue);
		} else {
			System.out.println("11th option not found in the dropdown");
			utilityclassobject.gettest().log(Status.FAIL, "11th option not found in the dropdown");
		}
	}
}
