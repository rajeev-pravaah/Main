...
public class TC_104AutomatiocSuspensiondropdownwithSetofvalue extends BaseClass80 {
	...
	@Test
	public void TC_104AutomatiocSuspensiondropdownwithSetofvalue() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		System.out.println("Total number of values in dropdown: " + numberOfValues);
		utilityclassobject.gettest().log(Status.INFO, "Total number of values in dropdown: " + numberOfValues);
		...
		for (int i = 0; i < allOptions.size(); i++) {
			...
			utilityclassobject.gettest().log(Status.INFO, "Option " + (i + 1) + ": " + optionText);
		}
	}
}
