...
public class TC_170ProvideBnakDetailsWithManual extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	LoginPage lp;
	HomePage hp;
	...
	@Test
	public void TC_170ProvideBnakDetailsWithManual() throws InterruptedException, EncryptedDocumentException, IOException {
