...
public class TC_183AddNoteinPaymentMethod extends BaseClass80{
	ExcelUtility elib;
	HomePage hp;
	BillingSettings bs;
	...
	@Test
	public void TC_183AddNoteinPaymentMethod() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		String note = elib.getDataFromExcel("BillingSettings", 10, 3);
		driver.findElement((By.xpath("//div[text()='"+acname+"']/ancestor::div[@class='flex-1']/descendant::div[@data-placeholder='Add a note...']"))).sendKeys(note);
