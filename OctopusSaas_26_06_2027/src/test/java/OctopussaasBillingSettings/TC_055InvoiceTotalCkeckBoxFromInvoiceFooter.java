...
public class TC_055InvoiceTotalCkeckBoxFromInvoiceFooter extends BaseClass80 {
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_055InvoiceTotalcheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getInvoiceTotalCheckbox2fromInvoicefooter().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Invoice total check box is unchecked successfully");
		System.out.println("INFO: Invoice total check box is unchecked successfully");
		bs.getInvoiceTotalCheckbox2fromInvoicefooter().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Invoice total check box is checked successfully");
