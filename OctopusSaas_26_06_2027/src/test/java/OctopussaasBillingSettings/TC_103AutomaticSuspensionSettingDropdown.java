...
public class TC_103AutomaticSuspensionSettingDropdown extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_103AutomaticSuspensionSettingdropdown() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		//fetch the default value from the dropdown without selecting any option do not use wlib
		String defaultValue = dropdown.getAttribute("value");
		System.out.println("Default value in the Automatic Suspension Setting dropdown: " + defaultValue);
		System.out.println("Default value in the Automatic Suspension"
				+ " Setting dropdown: " + defaultValue);
		utilityclassobject.gettest().log(Status.INFO, "Default value in the Automatic Suspension Setting dropdown is fetched successfully");
