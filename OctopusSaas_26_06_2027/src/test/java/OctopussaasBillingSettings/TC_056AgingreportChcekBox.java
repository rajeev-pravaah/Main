...
public class TC_056AgingreportChcekBox extends BaseClass80 {
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_056AgingreportCheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getAgingReportCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Aging report check box is unchecked successfully");
		System.out.println("INFO: Aging report check box is unchecked successfully");
		bs.getAgingReportCheckbox().click();
		Thread.sleep(2000); 	
		utilityclassobject.gettest().log(Status.INFO, "Aging report check box is checked successfully");
		System.out.println("INFO:Aging report check box is checked successfully");
