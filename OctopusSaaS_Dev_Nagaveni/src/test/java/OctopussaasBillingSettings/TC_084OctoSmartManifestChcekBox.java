...
public class TC_084OctoSmartManifestChcekBox extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_084OctoSmartManifestChcekBox() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		bs.getOctoSmartManifestCheckbox().click();
		utilityclassobject.gettest().log(Status.INFO, "Octo smart manifest checkbox is clicked successfully");
		System.out.println("INFO: Octo smart manifest checkbox is clicked successfully");
		bs.getOctoSmartManifestCheckbox().click();
		utilityclassobject.gettest().log(Status.INFO, "Octo smart manifest checkbox is checked successfully");
		System.out.println("INFO: Octo smart manifest checkbox is checked successfully");
