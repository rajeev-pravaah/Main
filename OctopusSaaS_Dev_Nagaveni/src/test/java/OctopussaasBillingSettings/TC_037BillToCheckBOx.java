...
public class TC_037BillToCheckBOx extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_037BillToCheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getBillToCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Bill to cehck box is unchecked successfully");
		System.out.println("INFO: Bill to cehck box is unchecked successfully");
		bs.getBillToCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Bill to cehck box is checked successfully");
		System.out.println("INFO: Bill to cehck box is checked successfully");
