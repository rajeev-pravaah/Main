...
public class TC_089InitialCheckBoxAutomaticReminder extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_089NotificationfrequencyIntialCheckBox() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		utilityclassobject.gettest().log(Status.INFO, "Notification frequency initial check box is clicked successfully");
		System.out.println("INFO: Notification frequency initial check box is clicked successfully");
		bs.getNotificationfrequencyinitialCheckBox().click();
		utilityclassobject.gettest().log(Status.INFO, "Notification frequency initial check box is Clicked successfully");
		System.out.println("INFO: Notification frequency initial check box is Clicked successfully");
