...
public class TC_035TermsCheckBox extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_035TermsChcekBOx() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getTermsCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Terms check box is unchecked successfully");
		System.out.println("INFO: Terms check box is unchecked successfully");
		//again check the terms checkbox
		bs.getTermsCheckbox().click();
		utilityclassobject.gettest().log(Status.INFO, "Terms check box is checked successfully");
		System.out.println("INFO: Terms check box is checked successfully");
