...
public class TC_039AutoPayStatus extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_039AutoPayStatus() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getAutopayStatus().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Autopay status check box is unchecked successfully");
		System.out.println("INFO: Autopay status check box is unchecked successfully");
		bs.getAutopayStatus().click();
		utilityclassobject.gettest().log(Status.INFO, "Autopay status check box is checked successfully");
		System.out.println("INFO: Autopay status check box is checked successfully");
