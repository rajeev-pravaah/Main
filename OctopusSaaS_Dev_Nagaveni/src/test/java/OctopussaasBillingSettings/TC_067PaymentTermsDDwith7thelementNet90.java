...
public class TC_067PaymentTermsDDwith7thelementNet90 extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_067PaymentTermsDDwitheSeventhelementNet90() throws InterruptedException {
		...
		// Verify that the 7th element is "Net 90"
			if (options.size() >= 7) {
		    String seventhOptionText = options.get(6).getText(); // Index is 0-based
		    System.out.println("7th Option Text: " + seventhOptionText);
		    utilityclassobject.gettest().log(Status.INFO, "7th option text: " + seventhOptionText);
		    if (seventhOptionText.equals("Net 90")) {
		        System.out.println("Verification Passed: 7th element is 'Net 90'");
		        utilityclassobject.gettest().log(Status.PASS, "Verification Passed: 7th element is 'Net 90'");
		    } else {
		        System.out.println("Verification Failed: 7th element is not 'Net 90'");
		        utilityclassobject.gettest().log(Status.FAIL, "Verification Failed: 7th element is not 'Net 90'");
		    }
		} else {
		    System.out.println("Verification Failed: Less than 7 options available");
		    utilityclassobject.gettest().log(Status.FAIL, "Verification Failed: Less than 7 options available");
		}
	}
}
