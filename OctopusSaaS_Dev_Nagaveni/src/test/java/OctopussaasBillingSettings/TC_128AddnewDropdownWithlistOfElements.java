...
public class TC_128AddnewDropdownWithlistOfElements extends BaseClass80 {
	...
	@Test
	public void TC_128AddnewDropdownWithlistOfElements() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		//click on that addnew dropdown
		bs.getAddNewDropdown().click();
		Thread.sleep(2000);
		//capture all the elements in that dropdown
		
		List<WebElement> dropdownItems = driver.findElements(By.xpath("//ul[@role='menu']//li"));

		// Fetch and print all dropdown values
		for(WebElement item : dropdownItems) {
		    System.out.println(item.getText());
		    utilityclassobject.gettest().log(Status.INFO, "Dropdown item: " + item.getText());
		}
	}
}
