...
public class TC_048QuantityChcekBox extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_048QuantitycheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getQuantityChcekbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Quantity  check box is unchecked successfully");
		System.out.println("INFO: Quantity  check box is unchecked successfully");
		bs.getQuantityChcekbox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Quantity    check box is checked successfully");
		System.out.println("INFO:Quantity   check box is checked successfully");
