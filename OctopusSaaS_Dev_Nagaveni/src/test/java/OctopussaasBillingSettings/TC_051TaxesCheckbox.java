...
public class TC_051TaxesCheckbox extends BaseClass80 {
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_051TaxescheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getTaxesCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Taxes check box is unchecked successfully");
		System.out.println("INFO: Taxes check box is unchecked successfully");
		bs.getTaxesCheckbox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Taxes  check box is checked successfully");
		System.out.println("INFO:Taxes check box is checked successfully");
