...
public class TC_116AutmaticSuspensiondropdownwith12thvlause extends BaseClass80 {
	...
	@Test
	public void TC_116AutmaticSuspensiondropdownwith12thvlause() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		// Fetch 12th value
		if (allOptions != null && allOptions.size() >= 12) {
			String twelfthValue = allOptions.get(11).getText().trim();
			System.out.println("12th Value from dropdown: " + twelfthValue);
			utilityclassobject.gettest().log(Status.INFO, "12th Value from dropdown: " + twelfthValue);
		} else {
			System.out.println("12th option not found in the dropdown");
			utilityclassobject.gettest().log(Status.FAIL, "12th option not found in the dropdown");
		}
	}
}
