...
public class TC_043GeneratorLocationNameCheckBox extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_043GeneratorLocationNamecheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getGeneratorLocationNameCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Generator Location Name check box is unchecked successfully");
		System.out.println("INFO: Generator Location Name check box is unchecked successfully");
		bs.getGeneratorLocationNameCheckbox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Generator Location Name check box is checked successfully");
		System.out.println("INFO: Generator Location Name check box is checked successfully");
