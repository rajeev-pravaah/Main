...
public class TC_100SubsequentDaysTxtWithoutCheck extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_100SubsequentDaysTxtWithoutcheck() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		WebElement textfield = bs.getSecondremindersentatintervalsSubsequentDaysTextfield();
		 checkbox.click();
