...
public class TC_161CancelPaymentInformation extends BaseClass80{
	...
	@Test
	public void TC_161CancelPaymentInformation() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		//bs.getSaveButtoninframe().click();
		bs.getCancelPaymentbutton().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.PASS, "Clicked on Cancel Payment button successfully");
		System.out.println("PASS: Clicked on Cancel Payment button successfully");
	}
}
