...
public class TC_049WeightCheckBox extends BaseClass80 {
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_049WeightcheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getWeightcheckBox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Weight  check box is unchecked successfully");
		System.out.println("INFO: Weight check box is unchecked successfully");
		bs.getWeightcheckBox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Weight  check box is checked successfully");
		System.out.println("INFO:Weight check box is checked successfully");
