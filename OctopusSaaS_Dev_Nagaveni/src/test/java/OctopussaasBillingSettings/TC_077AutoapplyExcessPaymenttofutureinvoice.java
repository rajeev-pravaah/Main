...
public class TC_077AutoapplyExcessPaymenttofutureinvoice extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_077AutopayExcessPaymentFutureInvoice() throws InterruptedException, EncryptedDocumentException, IOException {
		...
		Thread.sleep(2000);
		bs.getAutoapplyecxessradiobtn().click();
		utilityclassobject.gettest().log(Status.INFO, "Auto apply excess payment to future invoice option is selected successfully");			
		System.out.println("INFO: Auto apply excess payment to future invoice option is selected successfully");
	}
}
