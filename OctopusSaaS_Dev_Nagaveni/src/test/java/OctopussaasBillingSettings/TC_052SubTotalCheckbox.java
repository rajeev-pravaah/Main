...
public class TC_052SubTotalCheckbox extends BaseClass80 {
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_052SubTotalcheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getSubtotalCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "SubTotal check box is unchecked successfully");
		System.out.println("INFO: SubTotal check box is unchecked successfully");
		bs.getSubtotalCheckbox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "SubTotal  check box is checked successfully");
		System.out.println("INFO:SubTotal check box is checked successfully");
