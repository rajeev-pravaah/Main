...
public class TC_054DiscountCheckBox extends BaseClass80 {
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_054DiscountcheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getDiscountCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Discount check box is unchecked successfully");
		System.out.println("INFO: Discount check box is unchecked successfully");
		bs.getDiscountCheckbox().click();
		Thread.sleep(2000);	
		utilityclassobject.gettest().log(Status.INFO, "Discount check box is checked successfully");
		System.out.println("INFO:Discount check box is checked successfully");
