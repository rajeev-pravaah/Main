...
public class TC_038PreviousBalancecheckBox extends BaseClass80{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_038PreviousBalanceCheckBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		bs.getPreviousBalanceCheckbox().click();
		Thread.sleep(2000);
		utilityclassobject.gettest().log(Status.INFO, "Previous balance check box is unchecked successfully");
		System.out.println("INFO: Previous balance cehck box is unchecked successfully");
		bs.getPreviousBalanceCheckbox().click();
		utilityclassobject.gettest().log(Status.INFO, "Previous balance check box is checked successfully");
		System.out.println("INFO: Previous balance check box is checked successfully");
