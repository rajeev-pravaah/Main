...
public class TC_081ServiceRecipt extends Baseclass{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_081ServiceRecipt() throws InterruptedException, EncryptedDocumentException, IOException, AWTException, HeadlessException, UnsupportedFlavorException {
        ...
        WebElement scrollContainer = ras.getDeliverySummary();
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].scrollLeft = arguments[0].scrollWidth", scrollContainer);
        Assert.assertTrue(element.isDisplayed(),"Delivery Summary is not visible after horizontal scroll!");
		utilityclassobject.gettest().log(Status.INFO, "Delivery summary displayed successfully");
        ras.getServicesummarylink().click();
		utilityclassobject.gettest().log(Status.INFO, "Sertvice recipt displayed successfully");

        Thread.sleep(3000);     // Store main tab
		...
		utilityclassobject.gettest().log(Status.INFO, "Switch back to main tab");
