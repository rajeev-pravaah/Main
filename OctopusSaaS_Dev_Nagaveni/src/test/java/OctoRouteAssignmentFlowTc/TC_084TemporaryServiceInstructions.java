...
public class TC_084TemporaryServiceInstructions extends Baseclass{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_084TemporaryServiceInstruction() throws InterruptedException, EncryptedDocumentException, IOException, AWTException, HeadlessException, UnsupportedFlavorException {
		...
		Thread.sleep(3000);
		String ins = ras.TempuraryServiceInstruction();
		System.out.println(ins);
		utilityclassobject.gettest().log(Status.INFO, "Temporary Service Instructions displayed successfully");
