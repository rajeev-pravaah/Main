...
public class TC_085DriverNote extends Baseclass{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_085DriverNOte() throws InterruptedException, EncryptedDocumentException, IOException, AWTException, HeadlessException, UnsupportedFlavorException {
		...
		Thread.sleep(3000);
		String driverNote = ras.DriverNote();
		System.out.println(driverNote);
		utilityclassobject.gettest().log(Status.INFO, "Driver note  displayed successfully");
		Thread.sleep(6000);
