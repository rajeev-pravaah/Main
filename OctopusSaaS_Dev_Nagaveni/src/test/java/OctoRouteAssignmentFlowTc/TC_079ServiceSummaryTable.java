...
public class TC_079ServiceSummaryTable extends Baseclass{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_079() throws InterruptedException, EncryptedDocumentException, IOException, AWTException, HeadlessException, UnsupportedFlavorException {
        ...
        Thread.sleep(5000);
        WebElement serviceSummary = ras.getServiceSummaryBox();

        // Verify it is displayed
        Assert.assertTrue(serviceSummary.isDisplayed(), "Service Summary heading is NOT displayed!");
		utilityclassobject.gettest().log(Status.INFO, "Service summary table successfully");
