...
public class TC_076CopyServiceDateToclipBoard extends Baseclass{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_076ServicedateCopyToclipborad() throws InterruptedException, EncryptedDocumentException, IOException, AWTException, HeadlessException, UnsupportedFlavorException {
		...
		ras.getCopyservicedateToclipboard().click();
		utilityclassobject.gettest().log(Status.INFO, "Service date copied  successfully");
		Robot robot = new Robot();
		// Open clipboard history
		robot.keyPress(KeyEvent.VK_WINDOWS);
		robot.keyPress(KeyEvent.VK_V);
		utilityclassobject.gettest().log(Status.INFO, "Clipboard open successfully");
		robot.keyRelease(KeyEvent.VK_V);
		robot.keyRelease(KeyEvent.VK_WINDOWS);
		utilityclassobject.gettest().log(Status.INFO, "Service date paste on clip board successfully");
		robot.keyPress(KeyEvent.VK_ESCAPE);
		robot.keyRelease(KeyEvent.VK_ESCAPE);
		utilityclassobject.gettest().log(Status.INFO, "Clipboard closed ");
