...
public class TC_082DeliverSummaryRecipt extends Baseclass{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_082deliverSummaryRecipt() throws InterruptedException, EncryptedDocumentException, IOException, AWTException, HeadlessException, UnsupportedFlavorException {
		...
		Thread.sleep(5000);
		ras.getDeliversummaryreciptlink().click();
		utilityclassobject.gettest().log(Status.INFO, "Delivery summary recipt displayed successfully");
