...
public class TC_092NextSixserviceWithoutOfficehours extends Baseclass{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_092Next6ServiceWithoutofficeHours() throws InterruptedException, EncryptedDocumentException, IOException, AWTException
	{
    	...
    	List<WebElement> naValues = driver.findElements(
    		    By.xpath("//h6[text()='Next 6 Services If Saved']/following::p[text()='N/A']")
    		);

    		// Verify count is 6
    		if (naValues.size() == 6) {
    		    System.out.println("All 6 values are N/A");
            	utilityclassobject.gettest().log(Status.INFO, "Next 6 service without office hour not displayed successfully");

    		} else {
    		    System.out.println("Mismatch. Found: " + naValues.size());
    		}
