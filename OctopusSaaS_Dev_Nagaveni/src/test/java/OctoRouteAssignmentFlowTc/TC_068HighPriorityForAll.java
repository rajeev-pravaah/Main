...
public class TC_068HighPriorityForAll extends Baseclass{
	ExcelUtility elib;
	javautility jlib;
	...
	@Test
	public void TC_068HighPriorityForAllServices() throws InterruptedException, EncryptedDocumentException, IOException, AWTException
	{
    	...
    	Thread.sleep(15000);
    	ras.CopyToclipBoard();
    	ras.getCheckboxInScheduleservices().click();
    	String PriorityStatus = ras.getHighPriority().getText();
    	System.out.println(PriorityStatus);
    	utilityclassobject.gettest().log(Status.INFO, "Priority changes from normal to high priority");
    	ras.getHighPriorityForalll().click();
    	utilityclassobject.gettest().log(Status.INFO, "Priority changes from normal to high priority for all Services");
