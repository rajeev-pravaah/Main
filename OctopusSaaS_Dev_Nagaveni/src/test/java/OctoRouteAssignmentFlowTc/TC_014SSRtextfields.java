...
public class TC_014SSRtextfields extends Baseclass{
	ExcelUtility elib;
	javautility jlib;
	...
	RouteAssignment ras;
	@Test
	public void TC_014() throws EncryptedDocumentException, IOException, InterruptedException, AWTException
	{
	...
	ras.getSSRbtn().click();
	utilityclassobject.gettest().log(Status.INFO, "SSR displayed required fields");
